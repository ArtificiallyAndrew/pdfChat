...
def main():
    ...
    if pdf_file is not None:
        ...
        chain = ConversationalRetrievalChain.from_llm(ChatOpenAI(model_name="gpt-4o",max_tokens=4000,temperature=0.3,streaming=True),retriever=vectorstore.as_retriever(),memory=memory)
